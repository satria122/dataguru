...
class Home extends AUTH_Controller {
	...
	public function index() {
		...
		$data['jumlah_hampirpensiun']	= $this->db->query("select count(*) as total from pegawai where tgl_pensiun > '$today' and tgl_menjelang_pensiun < '$today' and kota='PNS'")->result_array();
		$data['list_hampirpensiun']		= $this->db->query("select * from pegawai where tgl_pensiun > '$today' and tgl_menjelang_pensiun < '$today' and kota='PNS' order by id desc limit 0,8")->result_array();
