...
class Kota extends AUTH_Controller {
	...
	public function index() {
		...
		$data['deskripsi'] 	= "Manage Data Status";
	...
	public function prosesTambah() {
		...
		if ($this->form_validation->run() == TRUE) {
			...
			if ($result > 0) {
				$out['status'] = '';
				$out['msg'] = show_succ_msg('Data Status Berhasil ditambahkan', '20px');
			} else {
				$out['status'] = '';
				$out['msg'] = show_err_msg('Data Status Gagal ditambahkan', '20px');
			}
		} else {
			$out['status'] = 'form';
	...
	public function prosesUpdate() {
		...
		if ($this->form_validation->run() == TRUE) {
			...
			if ($result > 0) {
				$out['status'] = '';
				$out['msg'] = show_succ_msg('Data Status Berhasil diupdate', '20px');
			} else {
				$out['status'] = '';
				$out['msg'] = show_succ_msg('Data Status Gagal diupdate', '20px');
			}
		} else {
			$out['status'] = 'form';
			$out['msg'] = show_err_msg(validation_errors());
	...
	public function delete() {
		...
		if ($result > 0) {
			echo show_succ_msg('Data Status Berhasil dihapus', '20px');
		} else {
			echo show_err_msg('Data Status Gagal dihapus', '20px');
		}
	}
